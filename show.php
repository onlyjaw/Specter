...
<head>
    ...
    <!-- ربط ملف الـ CSS -->
    <link rel="stylesheet" href="staa.css?v=1"> 
</head>
<body>
    <div class="container">
        <?php
        if ($car1 && $car2) {
            ...
            // إضافة صورة السيارة الأولى باستخدام الشيفرة PHP 
            if (!empty($car1['image'])) {
                echo "<div class='car-image'>";
                echo "<img src='image/" . $car1['image'] . "' alt='" . $car1['car_name'] . "' class='car-image-img'>";
                echo "</div>";
            }
            ...
            // إضافة صورة السيارة الثانية باستخدام الشيفرة PHP
            if (!empty($car2['image'])) {
                echo "<div class='car-image'>";
                echo "<img src='image/" . $car2['image'] . "' alt='" . $car2['car_name'] . "' class='car-image-img'>";
                echo "</div>";
            }
